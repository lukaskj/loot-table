...
export default class RandomItem {
  ...
  public static fromJson(randomItem: RandomItemJsonInterface): RandomItem {
    ...
    if (!!randomItem.rarities && Array.isArray(randomItem.rarities)) {
      randomItem.rarities.forEach((it) =>
        rdItemResult._addRarity({
          chance: it.chance,
          property: it.rarity,
          value: it.value,
        }),
    ...
    if (!!randomItem.attributes && Array.isArray(randomItem.attributes)) {
      randomItem.attributes.forEach((it) =>
        rdItemResult._addAttribute({
          chance: it.chance,
    ...
    if (!!randomItem.slots && Array.isArray(randomItem.slots)) {
      randomItem.slots.forEach((it) =>
        rdItemResult._addSlot({
          chance: it.chance,
          property: it.slot,
          value: it.value,
        }),
    ...
    if (!!randomItem.types && Array.isArray(randomItem.types)) {
      randomItem.types.forEach((it) =>
        rdItemResult._addType({
          chance: it.chance,
          property: it.type,
          value: it.value,
        }),
    ...
    if (!!randomItem.materials && Array.isArray(randomItem.materials)) {
      randomItem.materials.forEach((it) =>
        rdItemResult._addMaterial({
          chance: it.chance,
